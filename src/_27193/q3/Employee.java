...
public class Employee extends Manager {
    ...
    public Employee(int id, java.time.LocalDate createdDate, java.time.LocalDate updatedDate,
        ...
        if (employeeId <= 0) throw new PayrollDataException("Employee ID must be > 0 27193");
        if (!contactNumber.matches("\\d{10}")) throw new PayrollDataException("Contact should be 10 digits 27193");
