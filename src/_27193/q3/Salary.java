...
public class Salary extends Deduction {
    ...
    public Salary(int id, java.time.LocalDate createdDate, java.time.LocalDate updatedDate,
        ...
        if (basicSalary <= 0) throw new PayrollDataException("salary must be greater than 0 27193");
    ...
    public void displaySalaryDetails() {
        System.out.println("Basic Salary: $" + basicSalary + " 27193");
        System.out.println("Gross Salary: $" + grossSalary + " 27193");
        System.out.println("Net Salary: $" + netSalary + " 27193");
    }
}