...
public class Result extends Exam {
    ...
    public Result(int id, java.time.LocalDate createdDate, java.time.LocalDate updatedDate,
        ...
        if (obtainedMarks < 0) throw new SchoolDataException("Obtained marks cannot be negative 27193");
        if (remarks.isEmpty()) throw new SchoolDataException("Remarks cannot be empty 27193");
