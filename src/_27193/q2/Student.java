...
public class Student extends Teacher {
    ...
    public Student(int id, java.time.LocalDate createdDate, java.time.LocalDate updatedDate,
        ...
        if (rollNumber <= 0) throw new SchoolDataException("Roll number must be > 0 27193");
        if (grade.isEmpty()) throw new SchoolDataException("Grade cannot be empty 27193");
        if (!contactNumber.matches("\\d{10}")) throw new SchoolDataException("Contact must be 10 digits 27193");
