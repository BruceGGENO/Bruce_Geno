...
public class Shipping extends Entity {
    ...
    public void setShippingAddress(String shippingAddress) {
        if (shippingAddress == null || shippingAddress.trim().isEmpty()) throw new IllegalArgumentException("shippingAddress cannot be empty (27193)");
    ...
    public void setShippingCost(double shippingCost) {
        if (shippingCost < 0) throw new IllegalArgumentException("shippingCost must be >= 0 (27193)");
