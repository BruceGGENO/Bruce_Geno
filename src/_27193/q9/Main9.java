    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (airlineName == null || airlineName.trim().isEmpty()) {
                throw new IllegalArgumentException("Airline name cannot be empty (27193)");
            }
            ...
            if (!isValidEmail(email)) {
                throw new IllegalArgumentException("Invalid contact email format (27193)");
            }

            System.out.println("Flight Number:");
            String flightNumber = sc.nextLine();
            if (flightNumber == null || flightNumber.trim().isEmpty()) {
                throw new IllegalArgumentException("Flight number cannot be empty (27193)");
            }
            
            System.out.println("Destination:");
            String destination = sc.nextLine();
            if (destination == null || destination.trim().isEmpty()) {
                throw new IllegalArgumentException("Destination cannot be empty (27193)");
            }
            ...
            if (departure.isBefore(LocalDateTime.now())) {
                throw new IllegalArgumentException("Departure date cannot be in the past (27193)");
            }

            System.out.println("Passenger Name:");
            String passengerName = sc.nextLine();
            if (passengerName == null || passengerName.trim().isEmpty()) {
                throw new IllegalArgumentException("Passenger name cannot be empty (27193)");
            }
            
            System.out.println("Passport Number:");
            String passport = sc.nextLine();
            if (passport == null || passport.trim().isEmpty()) {
                throw new IllegalArgumentException("Passport number cannot be empty (27193)");
            }
            
            System.out.println("Nationality:");
            String nationality = sc.nextLine();
            if (nationality == null || nationality.trim().isEmpty()) {
                throw new IllegalArgumentException("Nationality cannot be empty (27193)");
            }

            System.out.println("Seat Number:");
            String seatNumber = sc.nextLine();
            if (seatNumber == null || seatNumber.trim().isEmpty()) {
                throw new IllegalArgumentException("Seat number cannot be empty (27193)");
            }
            ...
            if (ticketNumber == null || ticketNumber.trim().isEmpty()) {
                throw new IllegalArgumentException("Ticket number cannot be empty (27193)");
            }
            
            System.out.println("Ticket Price:");
            double price = Double.parseDouble(sc.nextLine());
            if (price <= 0) {
                throw new IllegalArgumentException("Ticket price must be positive (27193)");
            }

            System.out.println("Baggage Weight:");
            double baggageWeight = Double.parseDouble(sc.nextLine());
            if (baggageWeight < 0) {
                throw new IllegalArgumentException("Baggage weight cannot be negative (27193)");
            }
            
            System.out.println("Baggage Fee:");
            double baggageFee = Double.parseDouble(sc.nextLine());
            if (baggageFee < 0) {
                throw new IllegalArgumentException("Baggage fee cannot be negative (27193)");
            }
            ...
            if (paymentMode == null || paymentMode.trim().isEmpty()) {
                throw new IllegalArgumentException("Payment mode cannot be empty (27193)");
            }

            System.out.println("Total Fare:");
            double totalFare = Double.parseDouble(sc.nextLine());
            if (totalFare < 0) {
                throw new IllegalArgumentException("Total fare cannot be negative (27193)");
            }
