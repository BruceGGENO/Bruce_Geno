    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (companyName == null || companyName.trim().isEmpty()) {
                throw new IllegalArgumentException("Company name shouldn't be null");
            }
            ...
            if (branchName == null || branchName.trim().isEmpty()) {
                throw new IllegalArgumentException("Branch name shouldn't be null");
            }
            
            System.out.println("Location Code:");
            String locationCode = sc.nextLine();
            if (locationCode == null || locationCode.trim().isEmpty()) {
                throw new IllegalArgumentException("Location code shouldn't be null");
            }

            System.out.println("Vehicle Type:");
            String vehicleType = sc.nextLine();
            if (vehicleType == null || vehicleType.trim().isEmpty()) {
                throw new IllegalArgumentException("Vehicle type shouldn't be null");
            }
            
            System.out.println("Registration Number:");
            String regNumber = sc.nextLine();
            if (regNumber == null || regNumber.trim().isEmpty()) {
                throw new IllegalArgumentException("Registration number shouldn't be null");
            }
            ...
            if (custName == null || custName.trim().isEmpty()) {
                throw new IllegalArgumentException("Customer name shouldn't be null");
            }
            
            System.out.println("License Number:");
            String license = sc.nextLine();
            if (license == null || license.trim().isEmpty()) {
                throw new IllegalArgumentException("License number shouldn't be null");
            }
            ...
            if (paymentMode == null || paymentMode.trim().isEmpty()) {
                throw new IllegalArgumentException("Payment mode shouldn't be null");
            }
            
            System.out.println("Transaction ID:");
            String transactionId = sc.nextLine();
            if (transactionId == null || transactionId.trim().isEmpty()) {
                throw new IllegalArgumentException("Transaction ID shouldn't be null");
            }
